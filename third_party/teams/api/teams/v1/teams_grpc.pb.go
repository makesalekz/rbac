...
const (
	Teams_CreateTeam_FullMethodName  = "/api.teams.v1.Teams/CreateTeam"
	Teams_UpdateTeam_FullMethodName  = "/api.teams.v1.Teams/UpdateTeam"
	Teams_DeleteTeam_FullMethodName  = "/api.teams.v1.Teams/DeleteTeam"
	Teams_GetTeam_FullMethodName     = "/api.teams.v1.Teams/GetTeam"
	Teams_GetTeamTree_FullMethodName = "/api.teams.v1.Teams/GetTeamTree"
	Teams_ListTeams_FullMethodName   = "/api.teams.v1.Teams/ListTeams"
)
...
var Teams_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.teams.v1.Teams",
