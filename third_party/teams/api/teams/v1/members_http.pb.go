...
const OperationMembersCreateMembers = "/api.teams.v1.Members/CreateMembers"
const OperationMembersDeleteMember = "/api.teams.v1.Members/DeleteMember"
const OperationMembersListMembers = "/api.teams.v1.Members/ListMembers"
...
func RegisterMembersHTTPServer(s *http.Server, srv MembersHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/teams/{teamId}/members", _Members_CreateMembers0_HTTP_Handler(srv))
	r.DELETE("/v1/teams/{teamId}/members/{userId}", _Members_DeleteMember0_HTTP_Handler(srv))
	r.POST("/v1/teams/{teamId}/members/list", _Members_ListMembers0_HTTP_Handler(srv))
}
...
func (c *MembersHTTPClientImpl) CreateMembers(ctx context.Context, in *CreateMembersRequest, opts ...http.CallOption) (*CreateMembersReply, error) {
	...
	pattern := "/v1/teams/{teamId}/members"
...
func (c *MembersHTTPClientImpl) DeleteMember(ctx context.Context, in *DeleteMemberRequest, opts ...http.CallOption) (*DeleteMemberReply, error) {
	...
	pattern := "/v1/teams/{teamId}/members/{userId}"
...
func (c *MembersHTTPClientImpl) ListMembers(ctx context.Context, in *ListMembersRequest, opts ...http.CallOption) (*ListMembersReply, error) {
	...
	pattern := "/v1/teams/{teamId}/members/list"
	path := binding.EncodeURL(pattern, in, false)
