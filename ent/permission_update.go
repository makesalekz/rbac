...
func (pu *PermissionUpdate) AppendFields(s []string) *PermissionUpdate {
	pu.mutation.AppendFields(s)
	return pu
}
...
func (pu *PermissionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(permission.Table, permission.Columns, sqlgraph.NewFieldSpec(permission.FieldID, field.TypeInt32))
	...
	if value, ok := pu.mutation.AppendedFields(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, permission.FieldFields, value)
		})
	}
...
// AppendFields appends s to the "fields" field.
func (puo *PermissionUpdateOne) AppendFields(s []string) *PermissionUpdateOne {
	puo.mutation.AppendFields(s)
	return puo
}
...
func (puo *PermissionUpdateOne) sqlSave(ctx context.Context) (_node *Permission, err error) {
	...
	if value, ok := puo.mutation.AppendedFields(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, permission.FieldFields, value)
		})
	}
