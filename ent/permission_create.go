...
func (pc *PermissionCreate) AddRoles(r ...*RolePermission) *PermissionCreate {
...
func (u *PermissionUpsert) UpdateFields() *PermissionUpsert {
	u.SetExcluded(permission.FieldFields)
	return u
}
...
// UpdateFields sets the "fields" field to the value that was provided on create.
func (u *PermissionUpsertOne) UpdateFields() *PermissionUpsertOne {
	return u.Update(func(s *PermissionUpsert) {
		s.UpdateFields()
	})
}
...
// UpdateFields sets the "fields" field to the value that was provided on create.
func (u *PermissionUpsertBulk) UpdateFields() *PermissionUpsertBulk {
	return u.Update(func(s *PermissionUpsert) {
		s.UpdateFields()
	})
}
