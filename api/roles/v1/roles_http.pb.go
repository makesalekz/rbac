...
func RegisterRolesHTTPServer(s *http.Server, srv RolesHTTPServer) {
	...
	r.PUT("/v1/roles/{roleId}", _Roles_UpdateRole0_HTTP_Handler(srv))
	r.DELETE("/v1/roles/{roleId}", _Roles_DeleteRole0_HTTP_Handler(srv))
	r.GET("/v1/roles/{roleId}", _Roles_GetRole0_HTTP_Handler(srv))
	r.GET("/v1/roles", _Roles_ListRoles0_HTTP_Handler(srv))
	r.POST("/v1/roles/{roleId}/permissions", _Roles_AddPermissionToRole0_HTTP_Handler(srv))
	r.DELETE("/v1/roles/{roleId}/permissions/{permissionId}", _Roles_RemovePermissionFromRole0_HTTP_Handler(srv))
	r.GET("/v1/roles/{roleId}/permissions", _Roles_ListRolePermissions0_HTTP_Handler(srv))
}
...
func _Roles_AddPermissionToRole0_HTTP_Handler(srv RolesHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		reply := out.(*AddPermissionToRoleReply)
		return ctx.Result(200, reply)
	}
}
...
func (c *RolesHTTPClientImpl) AddPermissionToRole(ctx context.Context, in *AddPermissionToRoleRequest, opts ...http.CallOption) (*AddPermissionToRoleReply, error) {
	var out AddPermissionToRoleReply
...
func (c *RolesHTTPClientImpl) RemovePermissionFromRole(ctx context.Context, in *RemovePermissionFromRoleRequest, opts ...http.CallOption) (*EmptyReply, error) {
	var out EmptyReply
	pattern := "/v1/roles/{roleId}/permissions/{permissionId}"
	path := binding.EncodeURL(pattern, in, true)
