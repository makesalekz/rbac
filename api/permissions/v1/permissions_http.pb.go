...
func RegisterPermissionsHTTPServer(s *http.Server, srv PermissionsHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/permissions", _Permissions_CreatePermission0_HTTP_Handler(srv))
	r.PUT("/v1/permissions/{permissionId}", _Permissions_UpdatePermission0_HTTP_Handler(srv))
	r.DELETE("/v1/permissions/{permissionId}", _Permissions_DeletePermission0_HTTP_Handler(srv))
	r.GET("/v1/permissions/{permissionId}", _Permissions_GetPermission0_HTTP_Handler(srv))
	r.GET("/v1/permissions", _Permissions_ListPermissions0_HTTP_Handler(srv))
}
