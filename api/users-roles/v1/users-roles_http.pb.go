...
func RegisterUsersRolesHTTPServer(s *http.Server, srv UsersRolesHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/users/{userId}/roles/{roleId}", _UsersRoles_AssignRoleToUser0_HTTP_Handler(srv))
	r.DELETE("/v1/users/{userId}/roles/{roleId}", _UsersRoles_DeleteRoleFromUser0_HTTP_Handler(srv))
	r.GET("/v1/users/{userId}/roles", _UsersRoles_ListUserRoles0_HTTP_Handler(srv))
}
...
func (c *UsersRolesHTTPClientImpl) AssignRoleToUser(ctx context.Context, in *CreateUsersRolesRequest, opts ...http.CallOption) (*CreateUsersRolesReply, error) {
	...
	pattern := "/v1/users/{userId}/roles/{roleId}"
