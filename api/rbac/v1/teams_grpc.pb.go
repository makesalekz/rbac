...
const (
	Teams_CreateTeam_FullMethodName  = "/api.rbac.v1.Teams/CreateTeam"
	Teams_UpdateTeam_FullMethodName  = "/api.rbac.v1.Teams/UpdateTeam"
	Teams_DeleteTeam_FullMethodName  = "/api.rbac.v1.Teams/DeleteTeam"
	Teams_GetTeam_FullMethodName     = "/api.rbac.v1.Teams/GetTeam"
	Teams_GetTeamTree_FullMethodName = "/api.rbac.v1.Teams/GetTeamTree"
	Teams_ListTeams_FullMethodName   = "/api.rbac.v1.Teams/ListTeams"
)
