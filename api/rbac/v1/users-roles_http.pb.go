...
func RegisterUsersRolesHTTPServer(s *http.Server, srv UsersRolesHTTPServer) {
	...
	r.POST("/v1/rbac/users/list", _UsersRoles_ListUserRoles0_HTTP_Handler(srv))
	r.POST("/v1/rbac/teams/list", _UsersRoles_ListUserRolesByTeam0_HTTP_Handler(srv))
}
