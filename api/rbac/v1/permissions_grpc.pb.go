...
const (
	Permissions_CreatePermission_FullMethodName = "/api.rbac.v1.Permissions/CreatePermission"
	Permissions_UpdatePermission_FullMethodName = "/api.rbac.v1.Permissions/UpdatePermission"
	Permissions_DeletePermission_FullMethodName = "/api.rbac.v1.Permissions/DeletePermission"
	Permissions_GetPermission_FullMethodName    = "/api.rbac.v1.Permissions/GetPermission"
	Permissions_ListPermissions_FullMethodName  = "/api.rbac.v1.Permissions/ListPermissions"
)
...
func (c *permissionsClient) ListPermissions(ctx context.Context, in *ListPermissionsRequest, opts ...grpc.CallOption) (*ListPermissionsReply, error) {
	...
	err := c.cc.Invoke(ctx, Permissions_ListPermissions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Permissions_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.rbac.v1.Permissions",
