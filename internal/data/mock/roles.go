...
func (mr *MockRoleRepoMockRecorder) GetRolesList(ctx, tenantID, search interface{}, isSystem bool) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRolesList", reflect.TypeOf((*MockRoleRepo)(nil).GetRolesList), ctx, tenantID, search, isSystem)
}
