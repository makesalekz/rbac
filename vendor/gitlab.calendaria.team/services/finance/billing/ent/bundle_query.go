...
func (bq *BundleQuery) QueryProduct() *ProductQuery {
...
func (bq *BundleQuery) QueryItem() *ItemQuery {
	query := (&ItemClient{config: bq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := bq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (bq *BundleQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (bq *BundleQuery) FirstIDX(ctx context.Context) int64 {
...
func (bq *BundleQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (bq *BundleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (bq *BundleQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (bq *BundleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BundleQuery) WithProduct(opts ...func(*ProductQuery)) *BundleQuery {
	query := (&ProductClient{config: bq.config}).Query()
...
func (bq *BundleQuery) WithItem(opts ...func(*ItemQuery)) *BundleQuery {
	query := (&ItemClient{config: bq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (bq *BundleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Bundle, error) {
	...
	if query := bq.withProduct; query != nil {
		if err := bq.loadProduct(ctx, query, nodes, nil,
			func(n *Bundle, e *Product) { n.Edges.Product = e }); err != nil {
			return nil, err
		}
	}
	if query := bq.withItem; query != nil {
		if err := bq.loadItem(ctx, query, nodes, nil,
			func(n *Bundle, e *Item) { n.Edges.Item = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (bq *BundleQuery) loadProduct(ctx context.Context, query *ProductQuery, nodes []*Bundle, init func(*Bundle), assign func(*Bundle, *Product)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Bundle)
	for i := range nodes {
...
func (bq *BundleQuery) loadItem(ctx context.Context, query *ItemQuery, nodes []*Bundle, init func(*Bundle), assign func(*Bundle, *Item)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Bundle)
	for i := range nodes {
		fk := nodes[i].ItemID
...
func (bq *BundleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(bundle.Table, bundle.Columns, sqlgraph.NewFieldSpec(bundle.FieldID, field.TypeInt64))
	_spec.From = bq.sql
	...
	if fields := bq.ctx.Fields; len(fields) > 0 {
		...
		if bq.withProduct != nil {
			_spec.Node.AddColumnOnce(bundle.FieldProductID)
		}
		if bq.withItem != nil {
			_spec.Node.AddColumnOnce(bundle.FieldItemID)
		}
	}
