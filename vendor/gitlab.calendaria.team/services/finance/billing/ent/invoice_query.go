...
func (iq *InvoiceQuery) QueryProduct() *ProductQuery {
...
func (iq *InvoiceQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (iq *InvoiceQuery) FirstIDX(ctx context.Context) int64 {
...
func (iq *InvoiceQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (iq *InvoiceQuery) OnlyIDX(ctx context.Context) int64 {
...
func (iq *InvoiceQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (iq *InvoiceQuery) IDsX(ctx context.Context) []int64 {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (iq *InvoiceQuery) WithProduct(opts ...func(*ProductQuery)) *InvoiceQuery {
	query := (&ProductClient{config: iq.config}).Query()
...
func (iq *InvoiceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Invoice, error) {
	...
	if query := iq.withProduct; query != nil {
		if err := iq.loadProduct(ctx, query, nodes, nil,
			func(n *Invoice, e *Product) { n.Edges.Product = e }); err != nil {
			return nil, err
		}
	}
...
func (iq *InvoiceQuery) loadProduct(ctx context.Context, query *ProductQuery, nodes []*Invoice, init func(*Invoice), assign func(*Invoice, *Product)) error {
